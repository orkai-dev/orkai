...
type VolumeMount struct {
	...
	StorageClass string `json:"storage_class,omitempty"` // optional override; empty uses target default
...
type Application struct {
	...
	// Metadata
	IsCritical bool `bun:"is_critical,default:false" json:"is_critical"`
	...
	Provider string     `bun:"provider,default:'k3s'" json:"provider"`
	Region   string     `bun:"region,default:''" json:"region"`

	// K8s mapping (runtime config for k3s targets)
