...
const (
	...
	// ResourceCloudAccount holds AWS (and future cloud) account credentials used
	// to provision and manage customer infrastructure (S3 + CloudFront for Pages).
	// Distinct from ResourceObjectStorage, which is a backup-target bucket.
