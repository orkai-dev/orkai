...
const orkaiQuotaName = "orkai-quota"
...
func (o *Orchestrator) EnsureResourceQuota(ctx context.Context, namespace string, quota model.ResourceQuotaConfig) error {
	...
	existing, err := o.client.CoreV1().ResourceQuotas(namespace).Get(ctx, orkaiQuotaName, metav1.GetOptions{})
	if err != nil {
...
// DeleteResourceQuota removes the orkai ResourceQuota from the namespace.
func (o *Orchestrator) DeleteResourceQuota(ctx context.Context, namespace string) error {
	err := o.client.CoreV1().ResourceQuotas(namespace).Delete(ctx, orkaiQuotaName, metav1.DeleteOptions{})
