...
const orkaiNetPolName = "orkai-isolation"
...
func (o *Orchestrator) EnsureNetworkPolicy(ctx context.Context, namespace string, enabled bool) error {
	if !enabled {
		...
		err := o.client.NetworkingV1().NetworkPolicies(namespace).Delete(ctx, orkaiNetPolName, metav1.DeleteOptions{})
	...
	existing, err := o.client.NetworkingV1().NetworkPolicies(namespace).Get(ctx, orkaiNetPolName, metav1.GetOptions{})
	if err != nil {
