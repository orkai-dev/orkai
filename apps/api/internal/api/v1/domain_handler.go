...
// @Success      200 {array} apidocs.Domain
// @Failure      403 {object} apidocs.ProblemDetail
// @Security     BearerAuth
// @Router       /apps/{id}/domains [get]
...
// @Produce      json
// @Param        id path string true "Application ID"
// @Param        body body apidocs.CreateDomainInput true "Request body"
// @Success      201 {object} apidocs.Domain
// @Failure      403 {object} apidocs.ProblemDetail
// @Security     BearerAuth
// @Router       /apps/{id}/domains [post]
...
// Generate godoc
// @Summary      Generate Traefik domain
// @Tags         domains
// @Produce      json
// @Param        id path string true "Application ID"
// @Success      201 {object} apidocs.Domain
// @Failure      403 {object} apidocs.ProblemDetail
// @Security     BearerAuth
// @Router       /apps/{id}/domains/generate [post]
...
// @Success      200 {object} apidocs.Domain
// @Failure      403 {object} apidocs.ProblemDetail
// @Security     BearerAuth
// @Router       /domains/{id} [patch]
