...
// ── Database engines ───────────────────────────────────────────────
// Moved to `@/features/databases/constants`. Re-exported for compatibility.
export { ENGINE_LABELS } from "@/features/databases/constants";

// ── Environments ───────────────────────────────────────────────────

export const ENVIRONMENTS = ["prod", "testing", "sandbox", "qa", "poc", "development"] as const;
...
/** Returns true when status should show a pulsing amber indicator */
export function statusDotPulse(status: string): boolean {
  return [
    "building",
    "deploying",
    "restarting",
