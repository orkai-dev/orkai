...
import { statusDotColor, statusDotPulse } from "@/lib/constants";
...
export function AppSearch() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh]">
      ...
      <div className="relative w-full max-w-md overflow-hidden border border-border bg-popover text-popover-foreground shadow-none">
                ...
                {item.type === "database" ? (
                  ...
                  <span
                    className={cn(
                      ...
                      statusDotPulse(item.status) && "status-dot-pulse",
                    )}
                  />
                )}
