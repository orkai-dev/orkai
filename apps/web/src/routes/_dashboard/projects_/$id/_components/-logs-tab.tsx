    ...
    <Card>
      ...
      <CardContent>
        {!hasPods ? (
          ...
          <div ref={containerRef} className="h-[400px] overflow-hidden border bg-log p-1" />
        )}
      </CardContent>
    </Card>
  );
      ...
      <CardContent>
        {subTab === "terminal" ? (
          ...
          <>
            ...
            {/* Log output */}
            <div className="h-[400px] overflow-auto border bg-log p-3 font-mono text-code-sm text-foreground">
