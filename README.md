<p align="center">
  <a href="https://github.com/orkai-dev/orkai">
    <img src="apps/web/public/favicon.svg" width="80" alt="Orkai" />
  </a>
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Open%20Source-Yes-863bff" alt="Open Source" />
  <a href="https://github.com/orkai-dev/orkai/releases"><img src="https://img.shields.io/github/v/release/orkai-dev/orkai?color=863bff" alt="Release" /></a>
</p>

<p align="center">
  <a href="https://github.com/orkai-dev/orkai">Documentation</a> ·
  <a href="https://github.com/orkai-dev/orkai/issues">Report Bug</a> ·
  <a href="https://github.com/orkai-dev/orkai/discussions">Discussions</a> ·
  <a href="README_CN.md">中文</a>
</p>

<p align="center"><img src=".github/screenshot.png" width="800" alt="Orkai Dashboard" /></p>
...
So we built Orkai on top of it.
...
```bash
curl -sSL https://get.orkai.dev/upgrade | sudo sh
```
...
> Orkai doesn't wrap Kubernetes — it **is** Kubernetes.<br/>
...
Orkai is open source.

---

<p align="center">
  <a href="mailto:hello@orkai.dev">Contact</a> ·
  <a href="https://github.com/orkai-dev/orkai">Documentation</a> ·
  <a href="https://github.com/orkai-dev/orkai/discussions">Community</a>
</p>
