#!/bin/sh
# Orkai upgrade script — manual entry point
# Usage: curl -sSL https://get.orkai.dev/upgrade | sudo sh
set -e
...
[ ! -f "$INSTALL_DIR/docker-compose.yml" ] && { printf "${RED}[error]${NC} Orkai not found. Run the installer first.\n"; exit 1; }
[ ! -f "$INSTALL_DIR/.env" ] && { printf "${RED}[error]${NC} Configuration not found: $INSTALL_DIR/.env\n"; exit 1; }

printf "\n"
printf "${CYAN}  ⛵ Orkai Upgrade${NC}\n"
printf "\n"

CURRENT_IMAGE=$(docker inspect orkai --format '{{.Config.Image}}' 2>/dev/null || echo "unknown")
...
# ── Print summary ─────────────────────────────────────────────────
NEW_IMAGE=$(docker inspect orkai --format '{{.Config.Image}}' 2>/dev/null || echo "unknown")
printf "\n"
printf "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}\n"
